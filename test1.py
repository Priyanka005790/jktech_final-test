...
def sql_table(apple):
    ...
    # INSERT INTO employee VALUES(1001,'Priyanka', 'tokyo',0.23);
    # INSERT INTO employee VALUES(1002,'pawar', 'berlin',0.43);
    # INSERT INTO employee VALUES(1003,'kumar', 'chennai',0.13);
    # INSERT INTO employee VALUES(1004,'kumar', 'singapore',0.19);
    # """)
    #
    # apple.commit()
    #
